...
GROQ_API_KEY = os.environ.get("GROQ_API_KEY")          # Render में सेट करो
...
# GroqCloud OpenAI-compatible client
client = OpenAI(
    api_key=GROQ_API_KEY,
    base_url="https://api.groq.com/openai/v1"
)

# मॉडल – तू चाहे तो बदल सकता है (नीचे कमेंट में ऑप्शन दिए हैं)
...
# ========== RATE LIMITER (In-Memory) – Groq के फ्री टियर के हिसाब से ==========
