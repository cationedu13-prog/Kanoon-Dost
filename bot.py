...
# ========== CONFIGURATION ==========
# इन्हें Environment Variables से लेना सबसे सुरक्षित है,
# लेकिन टेस्टिंग के लिए नीचे सीधे भी डाल सकते हैं।
TELEGRAM_TOKEN = os.environ.get("TELEGRAM_TOKEN", "YOUR_TELEGRAM_BOT_TOKEN")
GEMINI_API_KEY = os.environ.get("GEMINI_API_KEY", "YOUR_GEMINI_API_KEY")
ADMIN_CHAT_ID = os.environ.get("ADMIN_CHAT_ID", None)  # Optional: आपकी चैट ID (पेमेंट नोटिफिकेशन के लिए)
...
def main():
    ...
    # बॉट को पोलिंग मोड में चलाएँ (Render Background Worker के लिए उपयुक्त)
    logger.info("⚖️ कानून दोस्त शुरू हो रहा है...")
